package com.gooodh.auth.handler.login.linuxdo;
...
public class LinuxDoApiClient {
    ...
    public String getTokenByCode(String code) {
        String tokenEndpoint = "https://connect.linuxdo.org/oauth2/token";
        System.out.println("LinuxDo getTokenByCode code");
        try {
            // 构建请求体
            ...
            // 发送请求体
            System.out.println("Sending LinuxDo token request...");
            ...
            // 读取响应
            System.out.println("LinuxDo token request sent.");
            ...
            // 解析响应
            System.out.println("LinuxDo token response received.");
    ...
    public Map<String, Object> getThirdUserInfo(String token) {
        String url = "https://connect.linuxdo.org/api/user";
        try {
            URL obj = new URL(url);
